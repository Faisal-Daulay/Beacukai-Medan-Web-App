              ...
              <div class="box box-success box-solid">
                ...
                <div class="box-body">
                  ...
                  include '../admin/include/koneksi.php';
                                      $sql="SELECT * FROM user u, registration r, newdata n where u.id_user=r.id_user and u.id_user=n.id_user and n.status_data='selesai'  order by n.tgl";
                                    ...
                                    <td><?php echo $tgl ; ?></td>
                                      ...
                                      <td>
                                      <a class="btn btn-primary" href="?page=olddata/olddata_lihat.php&id=<?php echo $id; ?>">Lihat</a>

<?php
	...
	if ($naper !=="") {
		if ($pass1==$pass2) {
			...
			$sql = "INSERT INTO registration (nama_perusahaan, npwp, alamat, email, nama_penjawab, alamat_penjawab,  tgl_skepawal, tgl_skepakhir, tlpn_perusahaan, no_faxperusahaan, emai_pru, img, noawal, noakhir,id_user,tgl_daftar,zona) VALUES ('$naper', '$npwp', '$alamat', '$email', '$napen', '$alapen', '$tgl1', '$tgl2', '$notel', '$fax', '$email_peru', '$name_file', '$noawal', '$noakhir','$po','$date','')";
